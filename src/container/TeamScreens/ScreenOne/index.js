import { View, Text, Image, ImageBackground, TouchableOpacity, Platform, Linking, ScrollView } from 'react-native';
      ...
      <ImageBackground
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ flex: 1, alignItems: 'center', marginTop: 100 }}>
            ...
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => Linking.openURL('https://fansplaylouder.com/fifa-live-streaming/')}
              style={{ flexDirection: 'row', alignItems: 'center', width: '70%', marginVertical: 20 }}>
