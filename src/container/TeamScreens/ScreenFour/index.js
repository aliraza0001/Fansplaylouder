import { View, Text, ImageBackground, TouchableOpacity, Platform, Linking, Image, ScrollView } from 'react-native';
import React from 'react';
import { styles } from './style';
import { basketballSc, basketball2, basketball } from '../../../assets/images';
    ...
    <>
      <ImageBackground
        ...
        <TextComponent
          ...
          text={'back'}
          style={[styles.textStyles, { marginTop: Platform.OS == 'ios' ? 40 : 10 }]}
        />
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ flex: 1, alignItems: 'center', marginTop: 100 }}>
            ...
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => Linking.openURL('https://fansplaylouder.com/nba-live-streaming/')}
              style={{ flexDirection: 'row', alignItems: 'center', width: '70%', marginVertical: 20 }}>
