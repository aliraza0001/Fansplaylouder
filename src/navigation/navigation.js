  ...
  return (
    <NavigationContainer>
      <Stack.Navigator
        ...
        <Stack.Screen name="TeamListSoccer" component={Screens.TeamListSoccer} />
        <Stack.Screen name="TeamListDetail" component={Screens.TeamListDetail} />
        ...
        <Stack.Screen name="SingleNewsFeed" component={Screens.SingleNewsFeed} />
